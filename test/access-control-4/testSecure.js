...
describe('Access Control Exercise 4', function () {
    ...
    before(async function () {
        ...
        const StarlightFactory = await ethers.getContractFactory(
            'contracts/access-control-4/StarlightSecured.sol:Starlight',
            deployer
        );
    ...
    it('Exploit', async function () {
        ...
        const HackerFactory = await ethers.getContractFactory(
            'contracts/access-control-4/StarlightSecure.sol:Hacker',
            attacker
        );
        this.hacker = await HackerFactory.deploy(this.starlight.address);
